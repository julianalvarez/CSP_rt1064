...
- name: BOARD_InitSPI2
  ...
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitTIMER
  UUID: 0401e36a-c14d-4e76-ae26-f55003b9fc85
  id_prefix: BOARD_
  selectedCore: core0
...
/***********************************************************************************************************************
 * BOARD_InitSPI2 functional group
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
- custom_name_enabled: 'false'
- type_id: 'nvic_57b5eef3774cc60acaede6f5b8bddc67'
- functional_group: 'BOARD_InitSPI2'
- peripheral: 'NVIC'
- config_sets:
  - nvic:
    - interrupt_table:
...
/***********************************************************************************************************************
 * BOARD_InitTIMER functional group
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
- custom_name_enabled: 'false'
- type_id: 'nvic_57b5eef3774cc60acaede6f5b8bddc67'
- functional_group: 'BOARD_InitTIMER'
- peripheral: 'NVIC'
- config_sets:
  - nvic:
    - interrupt_table:
...
/* Empty initialization function (commented out)
static void BOARD_NVIC_6_init(void) {
} */
...
static void BOARD_PIT_init(void) {
  /* Initialize the PIT. */
